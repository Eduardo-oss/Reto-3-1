...
public class SucursalForm extends javax.swing.JDialog {
  ...
  public void recibeIdDireccion(int idDireccion){
    ...
    try {
      connection = conexion.getConnection(); //validar si hay conexion
  ...
  private void initComponents() {
    ...
    jPanel1Layout.setHorizontalGroup(
      ...
      .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        .addGap(18, 18, 18)
        .addComponent(txtSucursal, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE)
        .addGap(18, 18, 18)
